...
pic_interval = 60
extension = ".jpg"
folder = "/home/osboxes/PAYLOADTESTFOLDER/%s/" % strftime("%m%d%Y_%H%M%S")
...
##Place Camera Functions here - Andrew
#enable_camera_A()
...
def reset_cam(): #Change this to apply to Chameleon Camera - Andrew
    global width
    global height
    global sharpness
    global brightness
